...
<br>
	...
	<form action="" method="post">
		...
		<div id="divAddCl" class="form_uni">
			...
			<div class="text_input"><span>Телефон: </span><input type="text" id="c_phone"><br></div>
			<div class="text_input"><span>Комментарий: </span><input type="text" id="c_comment"><br></div>
